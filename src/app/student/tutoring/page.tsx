...
export default function TutoringPage() {
  ...
  const [processedAvailability, setProcessedAvailability] = React.useState<Record<string, string[]>>({});
  ...
  React.useEffect(() => {
    if (selectedTeacher) {
      ...
      for (const dayOffset in selectedTeacher.availability) {
        ...
        newAvailability[formattedDate] = selectedTeacher.availability[dayOffset];
      }
          ...
          <Card>
            ...
            <CardContent className="p-2 flex justify-center">
              <Calendar
                ...
                disabled={(day) => !selectedTeacher || day < new Date() || !allAvailableDays.some(d => formatDate(d) === formatDate(day))}
              />
            </CardContent>
          </Card>
        </div>
