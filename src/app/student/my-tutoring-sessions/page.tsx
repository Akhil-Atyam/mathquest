...
/**
 * The main page component for the "My Tutoring Sessions" view.
 * It fetches the student's bookings from Firestore and displays them.
 */
export default function MyTutoringSessionsPage() {
  ...
  if (isLoading) {
    return (
      <div className="p-4 sm:p-6 space-y-6">
        <h1 className="text-3xl font-bold font-headline">My Tutoring Sessions</h1>
        <div className="space-y-4">
